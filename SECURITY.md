...
**➡️ [Report a vulnerability here](https://github.com/stpaine/FERS/security/advisories/new)**
...
- The simulator crashing on a malformed or invalid (but not maliciously crafted) `.fersxml` file. Please report these as
  regular [bug reports](https://github.com/stpaine/FERS/issues/new/choose).
